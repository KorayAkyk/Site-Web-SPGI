...
$dataPoints = array(
    //valeurs à modifier
	array("label"=> "Free ram %", "y"=> $ramFreePercent),
	array("label"=> "Used ram %", "y"=> $ramUsedPercent)
);
...
<a href='area.php'>Area</a>
  ...
  <main role="main">
	...
	<body>
      ...
      <form action="pie.php" method="post"> Nom PC : <input type="text" id="NomPC" name="PC"><br />
                <form action="pie.php" method="post"> Date : <input type="text" name="Date">
